...
class CostCalculator:
    @inject
    def __init__(self, user , policyChecker: PolicyChecker) :
        self.user = user
        self.deer_area_id = 1
        self.charging_policy = policyChecker

    def calculate(self):
        base_policy = self.charging_policy.base_policy(self, self.deer_area_id,BasePricing)
...
if __name__ == "__main__":
    ...
    costCalculator = CostCalculator(user, PolicyChecker)
